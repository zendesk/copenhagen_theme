...
describe("LookupField organization_id in autocomplete URL", () => {
  ...
  describe("when organizationId is invalid or missing", () => {
    ...
    test("omits organization_id when organizationId is undefined", async () => {
      render(
        <LookupField
          {...defaultProps}
    ...
    test("omits organization_id when organizationId is the string 'undefined'", async () => {
      render(
        <LookupField {...defaultProps} organizationId="undefined" />
      );
    ...
    test("omits organization_id when organizationId is empty string", async () => {
      render(<LookupField {...defaultProps} organizationId={""} />);
  ...
  describe("when organizationId is valid", () => {
    test("includes organization_id when organizationId is a valid string", async () => {
      render(
        <LookupField {...defaultProps} organizationId={"456"} />
      );
    ...
    test("includes organization_id when organizationId is '0'", async () => {
      render(<LookupField {...defaultProps} organizationId={"0"} />);
      ...
      expect(fetch).toHaveBeenCalledWith(
        expect.stringContaining("organization_id=0")
      );
    });
  });
});
