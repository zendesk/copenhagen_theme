...
describe("<FilterModal />", () => {
  ...
  describe("Date filters", () => {
    ...
    test("can filter by date custom fields - custom dates", async () => {
      ...
      const datepicker = screen.getByTestId("custom-datepicker");
      const calendarItem_1 = getAllByText(datepicker, "1")[0];
      const calendarItem_15 = getAllByText(datepicker, "15")[0];
    ...
    test("filter by custom created date", async () => {
      ...
      const datepicker = screen.getByTestId("custom-datepicker");
      const calendarItem_1_Aug = getAllByText(datepicker, "1")[0];
      const calendarItem_2_Aug = getAllByText(datepicker, "2")[0];
    ...
    test("can filter by date custom fields - future dates", async () => {
      ...
      const datepicker = screen.getByTestId("custom-datepicker");
      const calendarItem_19 = getAllByText(datepicker, "19")[0];
      const calendarItem_21 = getAllByText(datepicker, "21")[0];
