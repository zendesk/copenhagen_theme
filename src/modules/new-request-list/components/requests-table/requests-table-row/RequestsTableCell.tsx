...
The same applies for the description. */
  ...
  if (identifier === "requester") {
    ...
    return (
      <TruncatedTableCell
        identifier={identifier}
      >{`${nameOrAlias}`}</TruncatedTableCell>
    );
  }
