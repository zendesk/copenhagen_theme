...
function DatePicker({ field, locale, valueFormat, onChange }) {
   ...
   */
  const formatDateInput = reactExports.useCallback(
    (date) => {
  ...
  const formatDateValue = reactExports.useCallback(
    (value) => {
      if (value === undefined) {
        return "";
      }
...
function I({
    ...
    j = (function ({
      ...
      return e.useCallback(
        async (e) => {
          if (t && e && !c.current) {
            c.current = !0;
            const { createEditor: t } = await import("wysiwyg").then(function (
              e
            ) {
              return e.m;
            });
            (
              ...
              .on("show", (e, t) => {
                e.stop();
                const i =
                    t.message instanceof Error ? t.message.message : t.message,
                  { type: o, title: l } = t;
                n({ type: o, title: l, message: i });
              });
          }
        },
        [t, i, o, l, d, n]
  ...
  return t.jsxs(C, {
    children: [
      t.jsxs(l, {
        children: [r, _ && t.jsx(d, { "aria-hidden": "true", children: "*" })],
      }),
      b && t.jsx(c, { dangerouslySetInnerHTML: { __html: b } }),
      t.jsx(m, {
        ref: j,
        name: g,
        defaultValue: k,
      ...
      f && t.jsx(N, { validation: "error", children: f }),
    ],
  });
}
function q() {
  ...
  return t.jsxs(t.Fragment, {
    children: [
      t.jsx(d, { "aria-hidden": "true", children: "-" }),
      t.jsx(d, {
        hidden: !0,
        children: e(
          "cph-theme-ticket-fields.dropdown.empty-option",
          "Select an option"
        ),
      }),
    ],
...
function V({ field: i, onChange: o }) {
  ...
  return (
    e.useEffect(() => {
      if (f.current && p) {
        const e = f.current.querySelector("[role=combobox]");
    ...
    t.jsxs(k, {
      children: [
        t.jsxs(g, {
          children: [
            l,
            p && t.jsx(d, { "aria-hidden": "true", children: "*" }),
          ],
        }),
        h && t.jsx(_, { dangerouslySetInnerHTML: { __html: h } }),
        t.jsxs(b, {
          ref: f,
          inputProps: { name: a, required: p },
          isEditable: !1,
          validation: n ? "error" : void 0,
          inputValue: r,
          selectionValue: r,
          renderValue: ({ selection: e }) => e?.label || t.jsx(q, {}),
          onChange: ({ selectionValue: e }) => {
            void 0 !== e && o(e);
          },
          children: [
            !p && t.jsx(j, { value: "", label: "-", children: t.jsx(q, {}) }),
            c.map((e) =>
              t.jsx(j, { value: e.value.toString(), label: e.name }, e.value)
            ),
          ],
        }),
        n && t.jsx(y, { validation: "error", children: n }),
      ],
    })
  );
}
...
function G(e) {
  ...
  return {
    type: "SubGroup",
    name: e[e.length - 1],
    backOption: { type: "previous", label: "Back", value: t },
    options: [],
  };
}
function A({ options: t, hasEmptyOption: i }) {
  const o = e.useMemo(
      () =>
        (function (e, t) {
          const i = {
          ...
          return (
            e.forEach((e) => {
              ...
              if (t.includes("::")) {
                const [e, l] = (function (e) {
                    const t = e.split("::");
                    return [t.slice(0, -1), t.slice(-1)[0]];
                  })(t),
                  d = M(e);
                i[d] || (i[d] = G(e)),
                  i[d]?.options.push({
                ...
                for (let t = 0; t < e.length; t++) {
                  const o = e.slice(0, t),
                    ...
                    c = M(l);
                  i[d] || (i[d] = G(o)),
                    void 0 === i[d]?.options.find((e) => e.value === c) &&
                      i[d]?.options.push({
                        type: "next",
                        label: l[l.length - 1],
                        value: c,
              ...
              } else i[E].options.push({ value: o, label: t });
            }),
            i
          );
        })(t, i),
    ...
    [l, d] = e.useState(
      (function (e) {
        const t = { type: "RootGroup", options: [] };
        return (
          Object.values(e).forEach(({ options: e }) => {
            t.options.push(...e.filter(({ type: e }) => void 0 === e));
          }),
          t
        );
      })(o)
...
function R({ field: i, onChange: o }) {
  const {
    ...
    } = i,
    {
      currentGroup: r,
      isGroupIdentifier: f,
      setCurrentGroupByIdentifier: u,
    } = A({ options: c, hasEmptyOption: !1 }),
    [m, L] = e.useState(s || []),
    w = e.useRef(null);
  e.useEffect(() => {
    if (w.current && p) {
      const e = w.current.querySelector("[role=combobox]");
      e?.setAttribute("aria-required", "true");
    }
  }, [w, p]);
  return t.jsxs(k, {
    children: [
      m.map((e) =>
        t.jsx("input", { type: "hidden", name: `${a}[]`, value: e }, e)
      ),
      t.jsxs(g, {
        children: [l, p && t.jsx(d, { "aria-hidden": "true", children: "*" })],
      }),
      h && t.jsx(_, { dangerouslySetInnerHTML: { __html: h } }),
      t.jsxs(b, {
        ref: w,
        isMultiselectable: !0,
        inputProps: { required: p },
        isEditable: !1,
        validation: n ? "error" : void 0,
        onChange: (e) => {
          if (Array.isArray(e.selectionValue)) {
            const t = e.selectionValue.slice(-1).toString();
            f(t) ? u(t) : (L(e.selectionValue), o(e.selectionValue));
          }
        },
        selectionValue: m,
        maxHeight: "auto",
        children: [
          "SubGroup" === r.type && t.jsx(j, { ...r.backOption }),
          "SubGroup" === r.type
            ? t.jsx(S, {
                "aria-label": r.name,
                children: r.options.map((e) =>
                  t.jsx(j, { ...e, children: e.menuLabel ?? e.label }, e.value)
                ),
              })
            : r.options.map((e) => t.jsx(j, { ...e }, e.value)),
        ],
      }),
      n && t.jsx(y, { validation: "error", children: n }),
    ],
...
function F({ field: i, onChange: o }) {
  const {
    ...
    } = i,
    {
      ...
      isGroupIdentifier: f,
      setCurrentGroupByIdentifier: u,
    } = A({ options: c, hasEmptyOption: !0 }),
    m = s ?? "",
    [L, w] = e.useState(!1),
    x = e.useRef(null);
  e.useEffect(() => {
    if (x.current && p) {
      const e = x.current.querySelector("[role=combobox]");
      e?.setAttribute("aria-required", "true");
    }
  }, [x, p]);
  return t.jsxs(k, {
    children: [
      ...
      t.jsxs(b, {
        ref: x,
        inputProps: { required: p, name: a },
        isEditable: !1,
        validation: n ? "error" : void 0,
        onChange: (e) => {
          "string" == typeof e.selectionValue && f(e.selectionValue)
            ? u(e.selectionValue)
            : ("string" == typeof e.selectionValue && o(e.selectionValue),
              void 0 !== e.isExpanded && w(e.isExpanded));
        },
        selectionValue: m,
        inputValue: m,
        renderValue: ({ selection: e }) => e?.label ?? t.jsx(q, {}),
        ...
        children: [
          ...
          "SubGroup" === r.type
            ...
            : r.options.map((e) =>
                "" === e.value
                  ? t.jsx(j, { ...e, children: t.jsx(q, {}) }, e.value)
                  : t.jsx(j, { ...e }, e.value)
              ),
        ],
      }),
...
function H(e) {
  return e.replace("zen:custom_object:", "");
}
const D = { value: "", name: "-" };
function B({ field: i, userId: o, organizationId: l, onChange: c }) {
  const {
      id: n,
      label: s,
      error: p,
    ...
    T = e.useCallback(
      async (e) => {
        try {
          const t = await fetch(`/api/v2/custom_objects/${V}/records/${e}`);
          if (t.ok) {
            const { custom_object_record: e } = await t.json(),
              i = { name: e.name, value: e.id };
            v(i), O(e.name);
          }
        } catch (e) {
          console.error(e);
    ...
    G = e.useCallback(
      async (e) => {
        ...
        t.set("name", e.toLocaleLowerCase()),
          t.set("source", "zen:ticket"),
          t.set("field_id", n.toString()),
          t.set("requester_id", o.toString()),
          null !== l && t.set("organization_id", l),
          N(!0);
        try {
          const e = await fetch(
              `/api/v2/custom_objects/${V}/records/autocomplete?${t.toString()}`
            ),
            i = await e.json();
          if (e.ok) {
            let e = i.custom_object_records.map(({ name: e, id: t }) => ({
              name: e,
              value: t,
            }));
            x && ((e = e.filter((e) => e.value !== x.value)), (e = [x, ...e])),
              w(e);
          } else w([]);
        } catch (e) {
          console.error(e);
    ...
    A = e.useMemo(() => L(G, 300), [G]);
  e.useEffect(() => () => A.cancel(), [A]);
  const R = e.useCallback(
    ({ inputValue: e, selectionValue: t }) => {
      if (void 0 !== t)
        if ("" == t) v(D), O(D.name), w([]), c(D.value);
        else {
          const e = S.find((e) => e.value === t);
          e && (O(e.name), v(e), w([e]), c(e.value));
        }
      void 0 !== e && (O(e), A(e));
    },
    [A, c, S]
  ...
  return t.jsxs(k, {
    children: [
      t.jsxs(g, {
        children: [s, f && t.jsx(d, { "aria-hidden": "true", children: "*" })],
      }),
      u && t.jsx(_, { dangerouslySetInnerHTML: { __html: u } }),
      t.jsxs(b, {
        inputProps: { required: f },
        "data-test-id": "lookup-field-combobox",
        validation: p ? "error" : void 0,
        inputValue: z,
        selectionValue: x?.value,
        isAutocomplete: !0,
        placeholder: I(
        ...
        onChange: R,
        renderValue: () => (x ? x?.name : D.name),
        children: [
          x?.name !== D.name &&
            t.jsx(j, { value: "", label: "-", children: t.jsx(q, {}) }),
          C && t.jsx(j, { isDisabled: !0, value: E.name }, E.id),
          !C &&
            z?.length > 0 &&
            0 === S.length &&
            t.jsx(j, { isDisabled: !0, value: M.name }, M.id),
          !C &&
            0 !== S.length &&
            S.map((e) =>
              t.jsx(
      ...
      p && t.jsx(y, { validation: "error", children: p }),
      t.jsx("input", { type: "hidden", name: r, value: x?.value }),
    ],
  });
}
const W = ({
  ...
  userRole: l,
  userId: d,
  defaultOrganizationId: c,
  organizationField: n,
  brandId: s,
  dueDateField: a,
  handleDueDateChange: p,
  handleChange: h,
}) => {
  switch (e.type) {
    case "text":
    ...
    case "decimal":
    case "regexp":
      return t.jsx(O, { field: e, onChange: (t) => h(e, t) }, e.name);
    case "partialcreditcard":
      return t.jsx(v, { field: e, onChange: (t) => h(e, t) });
    case "textarea":
      return t.jsx(
        I,
        {
    ...
    case "checkbox":
      return t.jsx(w, { field: e, onChange: (t) => h(e, t) });
    case "date":
      return t.jsx(z, {
        field: e,
        locale: i,
    ...
    case "multiselect":
      return t.jsx(R, { field: e, onChange: (t) => h(e, t) });
    case "tagger":
      return t.jsx(F, { field: e, onChange: (t) => h(e, t) }, e.name);
    case "priority":
    case "basic_priority":
    case "tickettype":
      return t.jsxs(t.Fragment, {
        children: [
          t.jsx(V, { field: e, onChange: (t) => h(e, t) }, e.name),
          "task" === e.value &&
            a &&
            p &&
            t.jsx(z, {
    ...
    case "lookup":
      return t.jsx(
        B,
        {
          field: e,
          userId: d,
          organizationId: void 0 !== n ? n?.value : c,
          onChange: (t) => h(e, t),
        },
        e.name
      );
