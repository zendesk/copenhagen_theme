...
function LookupField({ field, userId, organizationId, onChange, visibleFields, buildLookupFieldOptions, }) {
...
const RequestFormField = ({ field, baseLocale, hasAtMentions, userRole, userId, defaultOrganizationId, organizationField, brandId, dueDateField, visibleFields, handleDueDateChange, handleChange, buildLookupFieldOptions, }) => {
    switch (field.type) {
        case "text":
        case "integer":
        case "decimal":
        ...
        case "lookup":
            return (jsxRuntimeExports.jsx(LookupField, { field: field, userId: userId, organizationId: organizationField !== null
                    ...
                    : defaultOrganizationId, visibleFields: visibleFields, onChange: (value) => handleChange(field, value), buildLookupFieldOptions: buildLookupFieldOptions }, field.name));
        default:
