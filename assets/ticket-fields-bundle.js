 ...
 */
function buildOptionLabels(nestedOptions) {
    const result = {};
 ...
 */
function findGroupForValue(nestedOptions, value) {
    if (!value) {
        return undefined;
    }
    return Object.values(nestedOptions).find(({ options }) => options.some((option) => option.type === undefined && option.value === value));
}
function useNestedOptions({ options, hasEmptyOption, selectedValue, }) {
    const { t } = useTranslation();
    ...
    const optionLabels = reactExports.useMemo(() => buildOptionLabels(nestedOptions), [nestedOptions]);
    const initialGroup = reactExports.useMemo(() => findGroupForValue(nestedOptions, selectedValue) ??
        nestedOptions[ROOT_GROUP_IDENTIFIER], [nestedOptions, selectedValue]);
    const [currentGroup, setCurrentGroup] = reactExports.useState(initialGroup);
    reactExports.useEffect(() => {
    ...
    const getOptionLabel = (value) => optionLabels[value];
    return {
        currentGroup,
        isGroupIdentifier,
...
function MultiSelect({ field, onChange, }) {
    const { label, options, error, value, name, required, description } = field;
    const { currentGroup, isGroupIdentifier, setCurrentGroupByIdentifier, getOptionLabel, } = useNestedOptions({
        options,
...
var ca = {
	"cph-theme-ticket-fields.attachments.choose-file-label": "Trieu un fitxer o arrossegueu-lo i deixeu-lo anar aquí",
	"cph-theme-ticket-fields.attachments.drop-files-label": "Deixeu anar els fitxers aquí",
	"cph-theme-ticket-fields.attachments.error-separator": ";",
	"cph-theme-ticket-fields.attachments.file": "Fitxer: {{fileName}}, premeu Supr per eliminar",
	"cph-theme-ticket-fields.attachments.remove-file": "Elimina el fitxer",
	"cph-theme-ticket-fields.attachments.remove-file-aria-label": "Elimina el fitxer: {{fileName}}",
	"cph-theme-ticket-fields.attachments.stop-upload": "Atura la càrrega",
	"cph-theme-ticket-fields.attachments.stop-upload-aria-label": "Atura la càrrega de {{fileName}}",
	"cph-theme-ticket-fields.attachments.upload-error-description": "Hi ha hagut un error en carregar {{fileName}}. Torneu-ho a provar o pugeu un altre fitxer.",
	"cph-theme-ticket-fields.attachments.upload-error-title": "Error de pujada",
	"cph-theme-ticket-fields.attachments.uploading": "S'està pujant {{fileName}}",
	...
	"cph-theme-ticket-fields.search-field.no-matches-found": "No s'han trobat coincidències",
	"cph-theme-ticket-fields.search-field.placeholder": "Cerca {{label}}",
	"cph-theme-ticket-fields.upload-failed-title": "S'ha produït un error en pujar {{fileName}}"
};
...
var et = {
	"cph-theme-ticket-fields.attachments.choose-file-label": "Vali pilt/fail või lohista see siia",
	"cph-theme-ticket-fields.attachments.drop-files-label": "Drop files here",
	"cph-theme-ticket-fields.attachments.error-separator": "; ",
	"cph-theme-ticket-fields.attachments.file": "File: {{fileName}}, press delete to remove",
	"cph-theme-ticket-fields.attachments.remove-file": "Remove file",
...
var lt = {
	"cph-theme-ticket-fields.attachments.choose-file-label": "Pasirinkite failą arba vilkite ir meskite čia",
	"cph-theme-ticket-fields.attachments.drop-files-label": "Drop files here",
	"cph-theme-ticket-fields.attachments.error-separator": "; ",
	"cph-theme-ticket-fields.attachments.file": "File: {{fileName}}, press delete to remove",
	"cph-theme-ticket-fields.attachments.remove-file": "Remove file",
...
var lv = {
	"cph-theme-ticket-fields.attachments.choose-file-label": "Izvēlieties failu vai velciet to šeit",
	"cph-theme-ticket-fields.attachments.drop-files-label": "Drop files here",
	"cph-theme-ticket-fields.attachments.error-separator": "; ",
	"cph-theme-ticket-fields.attachments.file": "File: {{fileName}}, press delete to remove",
	"cph-theme-ticket-fields.attachments.remove-file": "Remove file",
...
var pt = {
	"cph-theme-ticket-fields.attachments.choose-file-label": "Escolha um ficheiro ou arraste e solte aqui",
	"cph-theme-ticket-fields.attachments.drop-files-label": "Solte os ficheiros aqui",
	"cph-theme-ticket-fields.attachments.error-separator": "; ",
	"cph-theme-ticket-fields.attachments.file": "Prima Eliminar para remover o ficheiro: {{fileName}}",
	"cph-theme-ticket-fields.attachments.remove-file": "Remover ficheiro",
	"cph-theme-ticket-fields.attachments.remove-file-aria-label": "Remover ficheiro: {{fileName}}",
	"cph-theme-ticket-fields.attachments.stop-upload": "Parar o carregamento",
	"cph-theme-ticket-fields.attachments.stop-upload-aria-label": "Parar o carregamento do ficheiro {{fileName}}",
	"cph-theme-ticket-fields.attachments.upload-error-description": "Erro ao carregar {{fileName}}. Tente novamente ou carregue outro ficheiro.",
	"cph-theme-ticket-fields.attachments.upload-error-title": "Erro de carregamento",
	"cph-theme-ticket-fields.attachments.uploading": "A carregar {{fileName}}",
	"cph-theme-ticket-fields.credit-card-digits-hint": "(Últimos 4 dígitos)",
	"cph-theme-ticket-fields.dropdown.back-option-label": "Voltar",
