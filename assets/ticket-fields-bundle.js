import { s as styled, u as useTranslation, j as jsxRuntimeExports, F as FileList, a as File, T as Tooltip, P as Progress, A as Anchor, r as reactExports, b as Field, n as notify, c as useDropzone, d as FileUpload, I as Input$1, C as Checkbox$1, S as Span, M as MediaInput, e as SvgCreditCardStroke, D as DatePicker$1, f as Textarea, g as Field$1, h as Combobox, O as Option, i as debounce, k as OptGroup } from 'shared';
 ...
 */
function searchAllOptions(options, searchValue) {
    const results = [];
...
function MultiSelect({ field, onChange, }) {
    const { label, options: fieldOptions, error, value, name, required, description, } = field;
    const { t } = useTranslation();
    const { currentGroup, isGroupIdentifier, setCurrentGroupByIdentifier } = useNestedOptions({
        options: fieldOptions,
        hasEmptyOption: false,
    });
    const optionsMap = reactExports.useMemo(() => buildOptionsMap(fieldOptions || []), [fieldOptions]);
    const [selectedValues, setSelectedValues] = reactExports.useState(value || []);
    const [isExpanded, setIsExpanded] = reactExports.useState(false);
    const [inputValue, setInputValue] = reactExports.useState("");
    const [filteredOptions, setFilteredOptions] = reactExports.useState(currentGroup.options);
    const [isSearching, setIsSearching] = reactExports.useState(false);
    const wrapperRef = reactExports.useRef(null);
    const noResultsOption = {
        name: t("cph-theme-ticket-fields.search-field.no-matches-found", "No matches found"),
        id: "no-results",
    };
    reactExports.useEffect(() => {
        if (wrapperRef.current && required) {
    ...
    const filterOptions = reactExports.useCallback((searchValue) => {
    ...
    const debouncedFilterOptions = reactExports.useMemo(() => debounce(filterOptions, 300), [filterOptions]);
    reactExports.useEffect(() => {
    ...
    const handleChange = (changes) => {
        if (Array.isArray(changes.selectionValue)) {
            ...
            if (isGroupIdentifier(lastSelectedItem)) {
                ...
                setSelectedValues(changes.selectionValue);
    ...
    const visibleOptionValues = reactExports.useMemo(() => {
        if (isSearching) {
    ...
    const hiddenSelectedValues = reactExports.useMemo(() => selectedValues.filter((val) => !visibleOptionValues.has(val)), [selectedValues, visibleOptionValues]);
    return (jsxRuntimeExports.jsxs(Field$1, { children: [selectedValues.map((selectedValue) => (jsxRuntimeExports.jsx("input", { type: "hidden", name: `${name}[]`, value: selectedValue }, selectedValue))), jsxRuntimeExports.jsxs(Field$1.Label, { children: [label, required && jsxRuntimeExports.jsx(Span, { "aria-hidden": "true", children: "*" })] }), description && (jsxRuntimeExports.jsx(Field$1.Hint, { dangerouslySetInnerHTML: { __html: description } })), jsxRuntimeExports.jsxs(Combobox, { ref: wrapperRef, isMultiselectable: true, inputProps: { required }, isAutocomplete: true, validation: error ? "error" : undefined, onChange: handleChange, onFocus: handleFocus, selectionValue: selectedValues, inputValue: inputValue, maxHeight: "auto", placeholder: t("cph-theme-ticket-fields.search-field.placeholder", "Search {{label}}", { label }), isExpanded: isExpanded, children: [hiddenSelectedValues.map((val) => (jsxRuntimeExports.jsx(Option, { value: val, label: optionsMap.get(val) || val, isHidden: true }, val))), !isSearching && currentGroup.type === "SubGroup" && (jsxRuntimeExports.jsx(Option, { ...currentGroup.backOption })), isSearching ? (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [inputValue.length > 0 && filteredOptions.length === 0 && (jsxRuntimeExports.jsx(Option, { isDisabled: true, value: noResultsOption.id, children: noResultsOption.name }, noResultsOption.id)), filteredOptions.map((option) => (jsxRuntimeExports.jsx(Option, { value: option.value, label: option.label, children: option.menuLabel ?? option.label }, option.value)))] })) : currentGroup.type === "SubGroup" ? (jsxRuntimeExports.jsx(OptGroup, { "aria-label": currentGroup.name, children: currentGroup.options.map((option) => (jsxRuntimeExports.jsx(Option, { ...option, children: option.menuLabel ?? option.label }, option.value))) })) : (currentGroup.options.map((option) => (jsxRuntimeExports.jsx(Option, { ...option }, option.value))))] }), error && jsxRuntimeExports.jsx(Field$1.Message, { validation: "error", children: error })] }));
}
...
function Tagger({ field, onChange }) {
    ...
    const [selectionValue, setSelectionValue] = reactExports.useState(initialValue);
    const [selectedLabel, setSelectedLabel] = reactExports.useState(null);
    const [isExpanded, setIsExpanded] = reactExports.useState(false);
    const [inputValue, setInputValue] = reactExports.useState("");
    const [filteredOptions, setFilteredOptions] = reactExports.useState(currentGroup.options);
    const [isSearching, setIsSearching] = reactExports.useState(false);
    ...
    return (jsxRuntimeExports.jsxs(Field$1, { children: [jsxRuntimeExports.jsxs(Field$1.Label, { children: [label, required && jsxRuntimeExports.jsx(Span, { "aria-hidden": "true", children: "*" })] }), description && (jsxRuntimeExports.jsx(Field$1.Hint, { dangerouslySetInnerHTML: { __html: description } })), jsxRuntimeExports.jsxs(Combobox, { ref: wrapperRef, inputProps: { required }, isAutocomplete: true, validation: error ? "error" : undefined, onChange: handleChange, onFocus: handleFocus, selectionValue: selectionValue, inputValue: inputValue, placeholder: t("cph-theme-ticket-fields.search-field.placeholder", "Search {{label}}", { label }), renderValue: () => selectedLabel || EMPTY_OPTION_LABEL, isExpanded: isExpanded, children: [!isSearching && currentGroup.type === "SubGroup" && (jsxRuntimeExports.jsx(Option, { ...currentGroup.backOption })), isSearching ? (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [inputValue.length > 0 && filteredOptions.length === 0 && (jsxRuntimeExports.jsx(Option, { isDisabled: true, value: noResultsOption.id, children: noResultsOption.name }, noResultsOption.id)), filteredOptions.map((option) => option.value === "" ? (jsxRuntimeExports.jsx(Option, { value: option.value, label: option.label, children: jsxRuntimeExports.jsx(EmptyValueOption, {}) }, option.value)) : (jsxRuntimeExports.jsx(Option, { value: option.value, label: option.label, children: option.menuLabel ?? option.label }, option.value)))] })) : currentGroup.type === "SubGroup" ? (jsxRuntimeExports.jsx(OptGroup, { "aria-label": currentGroup.name, children: filteredOptions.map((option) => (jsxRuntimeExports.jsx(Option, { ...option, children: option.menuLabel ?? option.label }, option.value))) })) : (jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: filteredOptions.map((option) => option.value === "" ? (jsxRuntimeExports.jsx(Option, { ...option, children: jsxRuntimeExports.jsx(EmptyValueOption, {}) }, option.value)) : (jsxRuntimeExports.jsx(Option, { ...option }, option.value))) }))] }), error && jsxRuntimeExports.jsx(Field$1.Message, { validation: "error", children: error }), jsxRuntimeExports.jsx("input", { type: "hidden", name: name, value: selectionValue })] }));
}
