import { u as useToast, r as reactExports, j as jsxRuntimeExports, N as Notification, l as Title, m as Close, U as reactDomExports } from 'vendor-bundle';
...
function FlashNotifications({ notifications, }) {
    ...
    reactExports.useEffect(() => {
        for (const notification of notifications) {
            ...
            addToast(({ close }) => (jsxRuntimeExports.jsxs(Notification, { type: type, children: [title && jsxRuntimeExports.jsx(Title, { children: title }), message, jsxRuntimeExports.jsx(Close, { "aria-label": "Close", onClick: close })] })));
        }
    }, [addToast, notifications]);
    return jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {});
}

function renderFlashNotifications(settings) {
