...
function ServiceCatalogList({ helpCenterPath, }) {
    ...
    return (jsxRuntimeExports.jsxs(Container$1, { children: [jsxRuntimeExports.jsx(Search, { searchInputValue: searchInputValue, isLoading: isLoading, onChange: handleInputChange }), jsxRuntimeExports.jsx("span", { children: t("service-catalog.service-count", {
