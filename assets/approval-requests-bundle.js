...
function ApprovalRequestPage({ approvalRequestId, userId, }) {
    const { approvalRequest, errorFetchingApprovalRequest: error } = useApprovalRequest(approvalRequestId);
    if (error) {
        throw error;
    }
    ...
    return (jsxRuntimeExports.jsxs(Container, { children: [jsxRuntimeExports.jsxs(LeftColumn, { children: [jsxRuntimeExports.jsx(XXL, { isBold: true, children: approvalRequest?.subject }), jsxRuntimeExports.jsx(MD, { children: approvalRequest?.message }), approvalRequest?.ticket_details && (jsxRuntimeExports.jsx(ApprovalTicketDetails$1, { ticket: approvalRequest.ticket_details })), showApproverActions && jsxRuntimeExports.jsx(ApproverActions$1, {})] }), jsxRuntimeExports.jsx(RightColumn, { children: approvalRequest && (jsxRuntimeExports.jsx(ApprovalRequestDetails$1, { approvalRequest: approvalRequest })) })] }));
}
