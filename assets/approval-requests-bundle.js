import { r as reactExports, s as styled, g as Field, u as useTranslation, k as debounce, j as jsxRuntimeExports, M as MediaInput, a2 as SvgSearchStroke, h as Combobox, O as Option, q as Tag, am as Ellipsis, w as getColor, aH as MD, A as Anchor, an as Table, aM as Spinner, aN as XXL, Y as initI18next, Z as loadTranslations, _ as reactDomExports, a0 as ThemeProviders, a1 as createTheme, au as ErrorBoundary, ag as Grid, b as Field$1, L as Avatar, f as Textarea, E as Button, n as notify, aO as Breadcrumb, aP as Col, aQ as Row, aR as Label$1, aS as Message, aT as SM, aU as differenceInSeconds, aV as differenceInMinutes, aW as isSameYear, aX as isSameDay$1, aa as subDays, aY as SvgHeadsetFill, aZ as SvgCircleSmFill, X as Alert, a_ as Title, a$ as Close, H as getColorV8, b0 as React } from 'shared';
...
function ApprovalRequestDetails({ approvalRequest, baseLocale, }) {
    ...
    return (jsxRuntimeExports.jsxs(Container$2, { children: [jsxRuntimeExports.jsx(ApprovalRequestHeader, { isBold: true, children: t("approval-requests.request.approval-request-details.header", "Approval request details") }), jsxRuntimeExports.jsxs(DetailRow, { children: [jsxRuntimeExports.jsx(Grid.Col, { size: 4, children: jsxRuntimeExports.jsx(FieldLabel$1, { children: t("approval-requests.request.approval-request-details.sent-by", "Sent by") }) }), jsxRuntimeExports.jsx(Grid.Col, { size: 8, children: jsxRuntimeExports.jsx(WrappedText, { children: approvalRequest.origination_type === ORIGINATION_TYPES.ACTION_FLOW
                                ...
                                ? "Withdrawn on"
                                : "Decided") }) }), jsxRuntimeExports.jsx(Grid.Col, { size: 8, children: jsxRuntimeExports.jsxs(WrappedText, { children: [formatApprovalRequestDate(approvalRequest.decided_at, baseLocale), hasDecisionOriginationType &&
                                    ...
                                    ` ${t("approval-requests.request.approval-request-details.via-slack", "via Slack")}`, hasDecisionOriginationType &&
                                    approvalRequest.status !== APPROVAL_REQUEST_STATES.WITHDRAWN &&
                                    approvalRequest.decisions[0]?.origination_type === ORIGINATION_TYPES.UI &&
                                    ` ${t("approval-requests.request.approval-request-details.via-zendesk", "via Zendesk")}`] }) })] })), shouldShowPreviousDecision && approvalRequest.decisions[0] && (jsxRuntimeExports.jsx(ApprovalRequestPreviousDecision$1, { decision: approvalRequest.decisions[0], baseLocale: baseLocale }))] }));
}
