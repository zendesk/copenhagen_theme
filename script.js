import { R as ReactDOM, a as React, T as ThemeProvider, r as reactExports } from './assets/vendor.js';
...
function bootstrapComponent(element, Component) {
  try {
    ...
    ReactDOM.render( /*#__PURE__*/React.createElement(ThemeProvider, null, /*#__PURE__*/React.createElement(reactExports.Suspense, {
      fallback: ""
    }, /*#__PURE__*/React.createElement(Component, props))), element);
  } catch (e) {
    console.error(e);
  }
}
window.addEventListener("DOMContentLoaded", () => {
  if (window.location.pathname.endsWith("/requests/new")) {
    const NewRequestForm = /*#__PURE__*/React.lazy(() => import('./assets/NewRequestForm.js'));
